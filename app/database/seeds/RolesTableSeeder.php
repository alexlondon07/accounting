...
class RolesTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        $arr_roles = array(
            ...
            array('code' => '2', 'name' => 'Ver Usuarios'),
            array('code' => '2.1', 'name' => 'Crear Usuarios'),
            array('code' => '2.2', 'name' => 'Editar Usuarios'),
            array('code' => '2.3', 'name' => 'Eliminar Usuarios'),
            array('code' => '3', 'name' => 'Ver Proveedores'),
            array('code' => '3.1', 'name' => 'Crear Proveedores'),
            array('code' => '3.2', 'name' => 'Editar Proveedores'),
            array('code' => '3.3', 'name' => 'Eliminar Proveedores'),
            array('code' => '4', 'name' => 'Ver Costos'),
            array('code' => '4.1', 'name' => 'Crear Costos'),
            array('code' => '4.2', 'name' => 'Editar Costos'),
            array('code' => '4.3', 'name' => 'Eliminar Costos'),
